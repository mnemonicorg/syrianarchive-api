...
import {filter, partial, keys, map, flow, intersection, identity, pickBy, size, merge, sortBy, reverse, reduce, concat, curry, isEqual, keyBy, xor, take, find} from 'lodash/fp';
...
export const findunit = b => {
  ...
  return Promise.resolve(find(u => u.reference_code === b)(units));
};
