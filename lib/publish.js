...
${u.dem.summary_en} ${u.dem.summary_ar} ${u.dem.description} ${u.dem.online_title} ${u.dem.online_title_en} ${u.online_title_ar} ${u.dem.notes} ${u.dem.keywords} ${u.dem.collections} 
`;
