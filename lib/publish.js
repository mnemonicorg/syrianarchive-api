...
const geo = (u, i) => {
  ...
  return {
    ...
    properties: {
      ...
      event_summary: u.summary || u.description || u.online_title,
      eventcount: 1,
      pattrn_event_summary: u.summary || u.description || u.online_title,
...
findMany('units', { $or: [{'dem.veritom fied': 'TRUE' }, {'dem.verified': true}] })
  .then(us => {
    meta = {
      total: us.length,
      verified: us.length,
